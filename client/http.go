...
/** HTTP client which communicates with reminders backend API */
...
func (c HTTPClient) List(ids []string) ([]byte, error) {
...
/** Checks whether a given host is up and running */
